...
class Caminhao:
    ...
    def escolher_destino(self, grafo, caminhoes):
        ...
        for _, nome in opcoes:
            ...
            traj = dijkstra_trajeto(adj, self.posicao, nome)  # <-- idem aqui
    ...
    def atualizar_movimento(self, grafo, caminhoes, ativos):
        ...
        # ao parar num nó (seja após chegada ou inicial)
        ...
        # se agora tem trajeto, inicia movimento
        if self.trajeto:
            prox = self.trajeto[0]
            peso = None
            ...
            if peso is None:
                ...
                return  # ou continue, dependendo do que seu código deve fazer nesse caso
            self.tempo_restante.definir_max(peso)
